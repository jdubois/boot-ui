...
- Quarkus 3.37.x (`quarkus.platform.version` in the Quarkus modules; currently 3.37.1).
...
- **JDK caveat for the Quarkus sample app:** Hibernate ORM's build-time ByteBuddy enhancement (via the Quarkus
