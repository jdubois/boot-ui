...
- Quarkus 3.33 LTS for the extension and integration suites (`quarkus.platform.version` in the root `pom.xml`; currently
  3.33.3). The Quarkus sample app has a separate platform pin aligned with its Quarkus LangChain4j dependency.
