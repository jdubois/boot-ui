...
public class JvmTuningController {
    ...
    public JvmTuningController() {
        this(new MemoryReportProvider());
    }

    @Autowired
    public JvmTuningController(Environment environment) {
        this(new MemoryReportProvider(environment));
    }

    JvmTuningController(MemoryCalculator calculator) {
        this(new MemoryReportProvider(calculator));
    }

    JvmTuningController(MemoryReportProvider provider) {
