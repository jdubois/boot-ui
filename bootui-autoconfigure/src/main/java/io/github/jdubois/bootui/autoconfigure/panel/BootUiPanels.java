...
public final class BootUiPanels {
    ...
    public static final String DIAGNOSTICS_DASHBOARD = "diagnostics-dashboard";
    ...
    private static final List<Panel> PANELS = List.of(
            ...
            new Panel(DIAGNOSTICS_DASHBOARD, "Diagnostics dashboard", false, "/diagnostics-dashboard"));
