 ...
 */
final class RestApiAdvisorRuleSupport {
    ...
    private RestApiAdvisorRuleSupport() {}

    static RestApiAdvisorRuleResultDto pass(RestApiAdvisorRuleDefinition definition) {
        return result(definition, PASS, 0, List.of());
    }

    static RestApiAdvisorRuleResultDto skipped(RestApiAdvisorRuleDefinition definition, String reason) {
        return result(definition, SKIPPED, 0, List.of(detail(reason)));
    }

    static RestApiAdvisorRuleResultDto error(RestApiAdvisorRuleDefinition definition, String reason) {
     ...
     */
    static RestApiAdvisorRuleResultDto fromViolations(
            RestApiAdvisorRuleDefinition definition, List<String> violations) {
