...
rate, the slowest recent endpoint, active exception count, health status, and heap usage computed from the same buffers. Because the merged feed is genuinely
