 ...
 * from a weaker time-window-only one. Values follow BootUI's exposure/masking policy.</p>
 *
 ...
 */
public record RequestProfileSecurityDto(String type, String principal, long timestamp, boolean principalMatched) {}
