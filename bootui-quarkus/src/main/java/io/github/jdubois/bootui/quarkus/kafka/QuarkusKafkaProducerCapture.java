 ...
 * {@code Capability.KAFKA} is present, and {@linkplain io.quarkus.arc.deployment.ExcludedTypeBuildItem
 * excluded} from bean discovery otherwise) so Arc never links the messaging API in an app without
