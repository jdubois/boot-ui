...
/**
 * The Quarkus analogue of the Spring adapter's {@code ConstellationHttpPeerClientTests}, pinning that
 * {@link QuarkusConstellationPeerClient} (Jackson 2) behaves identically to the Spring client (Jackson 3).
 */
class QuarkusConstellationPeerClientTest {
    ...
    void fetchReadsIdentityFromOverviewAndPlatformFromPanels() throws Exception {
        ...
        json("/bootui/api/overview", """
                {"applicationName":"orders-service","frameworkName":"Quarkus","frameworkVersion":"3.33.2",
        ...
        QuarkusConstellationPeerClient client = new QuarkusConstellationPeerClient();
        ...
        assertThat(snapshot.frameworkVersion()).isEqualTo("3.33.2");
