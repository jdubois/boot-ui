...
class GitHubApiClientTest {
    ...
    void rejectsRefreshWhenApiHostIsNotAllowed() throws Exception {
        ...
        QuarkusGitHubSettings settings =
                new QuarkusGitHubSettings(Duration.ofSeconds(2), 10, 25, 20, 10, 17, List.of("api.github.com"));
    ...
    private GitHubApiClient client(String token) {
        QuarkusGitHubSettings settings =
                new QuarkusGitHubSettings(Duration.ofSeconds(2), 10, 25, 20, 10, 17, List.of("localhost"));
