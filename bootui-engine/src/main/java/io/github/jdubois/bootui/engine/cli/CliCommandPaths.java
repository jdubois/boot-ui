...
public final class CliCommandPaths {
    ...
    public static final Map<String, String> BY_TOOL = Map.ofEntries(
            ...
            Map.entry("postgresql_read", "db postgres read"),
            Map.entry("mysql_read", "db mysql read"),
            Map.entry("get_ai_overview", "ai overview"),
            Map.entry("get_architecture_report", "architecture report"),
            Map.entry("get_architecture_rule_violations", "architecture violations"),
            ...
            Map.entry("get_memory_rule_violations", "memory violations"),
            ...
            Map.entry("get_security_rule_violations", "security violations"),
            Map.entry("get_spring_data_repositories", "repositories"),
            Map.entry("get_spring_report", "spring report"),
            Map.entry("get_spring_rule_violations", "spring violations"),
