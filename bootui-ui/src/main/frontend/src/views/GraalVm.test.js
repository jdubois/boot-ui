...
function graalvmReport(
  ...
  return {
    ...
    metadataDirectory:
      metadataDirectory ?? 'src/main/resources/META-INF/native-image/com.example/demo-additional-hints/',
...
describe('GraalVm', () => {
  ...
  it('shows the resolved coordinates in the scaffold placement path', async () => {
    ...
    expect(wrapper.text()).toContain('src/main/resources/META-INF/native-image/com.example/demo-additional-hints/')
  })

  it('keeps the groupId/artifactId placeholders when coordinates are unresolved', async () => {
    const wrapper = await mountWithReport(
      graalvmReport([], {
        metadataDirectory: 'src/main/resources/META-INF/native-image/<groupId>/<artifactId>-additional-hints/'
      })
    )

    expect(wrapper.text()).toContain(
      'src/main/resources/META-INF/native-image/<groupId>/<artifactId>-additional-hints/'
    )
  })
