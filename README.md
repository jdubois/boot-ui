...
| Diagnostics     | [Log Tail](docs/FEATURES.md#log-tail)                                   | Read recent application logs and stream new local log events, with trace ids for cross-panel correlation.                                                |
| Diagnostics     | [HTTP Exchanges](docs/FEATURES.md#http-exchanges)                       | Review recent inbound application requests with masked headers, timings, status, and clickable trace identifiers.                                        |
