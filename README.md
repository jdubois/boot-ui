...
| Database        | [Flyway](docs/FEATURES.md#flyway)                                       | Inspect Flyway schema migrations, including Spring Modulith module-aware histories; optionally migrate or clean safe targets after confirmation.         |
