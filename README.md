...
| Services        | [Spring Security](docs/FEATURES.md#spring-security)                     | Inspect Spring Security filter chains and best-effort endpoint rule explanations.                                                       |
...
| Diagnostics     | [Security Logs](docs/FEATURES.md#security-logs)                         | Review recent Spring Boot audit/security events with masking, filtering, auto-refresh, and bounded retention.                          |
